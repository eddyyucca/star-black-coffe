...
<head>
  ...
  {{-- <link href="assets/https://fonts.googleapis.com/css?family=Rubik:300,400,700|Oswald:400,700" rel="stylesheet"> --}}
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="site-logo">
            <a href="index.html" class="text-black"><span class="text-primary">STAR BLACK CAFFE</a>
            </div>
      ...
      <div class="owl-carousel slide-one-item">
        ...
        <div class="site-section-cover overlay img-bg-section" style="background-image: url('assets/images/caffe/1.jpg'); " >
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-md-12 col-lg-7">
                <h1 data-aos="fade-up" data-aos-delay="">STAR BLACK CAFFE</h1>  
                ...
                <p data-aos="fade-up" data-aos-delay="200"><a href="assets/#" class="btn btn-outline-white border-w-2 btn-md">Get in touch</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="site-section-cover overlay img-bg-section" style="background-image: url('assets/images/caffe/2.jpg'); " >
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-md-12 col-lg-8">
                <h1 data-aos="fade-up" data-aos-delay="">NEW STAR BLACK CAFFE</h1>      
        ...
        <div class="block__73694 mb-2">
          <div class="container">
            <div class="row d-flex no-gutters align-items-stretch">
              ...
              <div class="col-12 col-lg-6 block__73422" style="background-image: url('assets/images/img_1.jpg');" data-aos="fade-right" data-aos-delay="">
              </div>
        ...
        <div class="block__73694">
          <div class="container">
            <div class="row d-flex no-gutters align-items-stretch">
              ...
              <div class="col-12 col-lg-6 block__73422 order-lg-2" style="background-image: url('assets/images/img_2.jpg');" data-aos="fade-left" data-aos-delay="">
              </div>
          ...
          <div class="row justify-content-center mb-4 block-img-video-1-wrap">
            <div class="col-md-12 mb-5">
              <figure class="block-img-video-1" data-aos="fade">
                <a href="assets/https://vimeo.com/45830194" data-fancybox data-ratio="2">
                  <span class="icon"><span class="icon-play"></span></span>
                  <img src="assets/assets/images/hero_2.jpg" alt="Image" class="img-fluid">
                </a>
              </figure>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
              <div class="block-team-member-1 text-center rounded">
                ...
                <div class="block-social-1">
                  <a href="assets/#" class="btn border-w-2 rounded primary-primary-outline--hover"><span class="icon-facebook"></span></a>
                  <a href="assets/#" class="btn border-w-2 rounded primary-primary-outline--hover"><span class="icon-twitter"></span></a>
                  <a href="assets/#" class="btn border-w-2 rounded primary-primary-outline--hover"><span class="icon-instagram"></span></a>
                </div>
              </div>
            </div>
        ...
        <div class="row mb-5">
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="pricing">
              ...
              <p class="text-center">
                <a href="assets/#" class="btn btn-secondary btn-md">Buy Now</a>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="pricing">
              ...
              <p class="text-center">
                <a href="assets/#" class="btn btn-primary btn-md text-white">Buy Now</a>
              </p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-6" data-aos="fade-up" data-aos-delay="">
            <div>
              <a href="assets/single.html" class="mb-4 d-block"><img src="assets/assets/images/hero_2.jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="assets/single.html">How To Find Gold In Mining</a></h2>
              <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">January 18, 2019</span> By <a href="assets/single.html" class="by">James Cooper</a></p>
              ...
              <p><a href="assets/single.html">Read More</a></p>
            </div>
          </div>
          <div class="col-md-6 col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div>
              <a href="assets/single.html" class="mb-4 d-block"><img src="assets/images/hero_3.jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="assets/single.html">How To Find Gold In Mining</a></h2>
              <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">January 18, 2019</span> By <a href="assets/single.html" class="by">James Cooper</a></p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat et suscipit iste libero neque. Vitae quidem ducimus voluptatibus nemo cum odio ab enim nisi, itaque, libero fuga veritatis culpa quis!</p>
              <p><a href="assets/single.html">Read More</a></p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <p><a href="assets/#" class="btn btn-primary text-white">Get Started</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-4 ml-auto">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="assets/#">Press Releases</a></li>
                  <li><a href="assets/#">Testimonials</a></li>
                  <li><a href="assets/#">Terms of Service</a></li>
                  <li><a href="assets/#">Privacy</a></li>
          ...
          <div class="col-md-4 ml-auto">
            ...
            <div class="mb-5">
              ...
              <a href="assets/#about-section" class="smoothscroll pl-0 pr-3"><span class="icon-facebook"></span></a>
              <a href="assets/#" class="pl-3 pr-3"><span class="icon-twitter"></span></a>
              <a href="assets/#" class="pl-3 pr-3"><span class="icon-instagram"></span></a>
              <a href="assets/#" class="pl-3 pr-3"><span class="icon-linkedin"></span></a>
            </form>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p class="copyright"><small>
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="assets/https://colorlib.com" target="_blank" >Colorlib</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </small></p>
            </div>
          </div>
